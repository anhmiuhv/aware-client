...
public class Aware extends Service {
    ...
    public void foreground(boolean enable) {
        if (enable) {
            ...
            mBuilder.setContentText(running ? getApplicationContext().getResources().getString(R.string.foreground_notification_text)
                    : getApplicationContext().getResources().getString(R.string.foreground_notification_text_not));
